...
int	calculate_shade_color(t_scene *scene,  double diffuse)
{
	...
	extracted_color = extract_color_components(object_color);
	shade_color.r = clamp((int)(ambient.ratio
				* extracted_color.r + diffuse * extracted_color.r), 0, 255);
	shade_color.g = clamp((int)(ambient.ratio
				* extracted_color.r + diffuse * extracted_color.g), 0, 255);
	shade_color.b = clamp((int)(ambient.ratio
